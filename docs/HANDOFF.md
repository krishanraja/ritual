...
```
VITE_SUPABASE_URL=https://gdojuuzlxpxftsfkmneu.supabase.co
VITE_SUPABASE_PUBLISHABLE_KEY=...
VITE_SUPABASE_PROJECT_ID=gdojuuzlxpxftsfkmneu
```
...
│   │   ├── AppShell.tsx    # App layout + navigation
│   │   ├── StatusIndicator.tsx
│   │   └── ...
│   ├── contexts/           # React contexts
│   │   └── CoupleContext.tsx   # Global state management
│   ├── hooks/              # Custom hooks
│   │   ├── use-toast.ts
│   │   ├── useMagneticSync.ts
│   │   └── ...
│   ├── integrations/       # External integrations
│   │   └── supabase/       # Supabase client (DON'T EDIT)
...
│   └── config.toml         # Supabase config (DON'T EDIT)
