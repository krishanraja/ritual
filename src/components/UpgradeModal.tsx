...
import { X, Sparkles, Camera, Repeat, Bell, Star, Heart, TrendingUp, Lock } from 'lucide-react';
...
interface UpgradeModalProps {
  open: boolean;
  onClose: () => void;
  highlightFeature?: 'rituals' | 'swaps' | 'photos' | 'nudges' | 'streaks';
}
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-md bg-card rounded-2xl shadow-xl border overflow-hidden"
        >
          {/* Header */}
          ...
          <div className="p-4 pt-0 space-y-3">
            ...
            >
              {loading ? 'Loading...' : `Upgrade for ${PREMIUM_PRICE}`}
            </Button>
